...
const Account = () => {
  ...
  const renderSettingsItem = (icon, title, subtitle, onPress, showDot = false) => (
  ...
  () => {
    setIsNewNotification(false); // clear the dot
    router.push("../screens/Notifications");
  },
  isNewNotification // pass this to show the orange dot
)}
